...
train_df = pd.Series('./Videos/FinishingtheSingleLegAllOptionsandCountersTalgatIlyasov.mp4')
test_df = pd.Series('./Projects/AI/Image_class_bjj/Videos/Armbar_by_EstevanMartinez.mp4')
...
label_processor = keras.layers.StringLookup(
    num_oov_indices=0, vocabulary=np.unique(["Single Leg"])
)
...
def run_experiment():
    filepath = "C:/Projects/AI/Image_class_bjj/video_classifier/ckpt.weights.h5"
...
test_video = './Videos/FinishingtheSingleLegAllOptionsandCountersTalgatIlyasov.mp4'
